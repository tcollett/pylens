...
class EnsembleSamplerTEC(Sampler):
    """
    ...
    **Warning**: The :attr:`chain` member of this object has the shape:
    ...
    def __init__(self, nwalkers, dim, lnpostfn, a=2.0, args=[], postargs=None,
        ...
        if postargs is not None:
            args = postargs
        super(EnsembleSamplerTEC, self).__init__(dim, lnpostfn, args=args)
    ...
    def reset(self):
        ...
        """
        super(EnsembleSamplerTEC, self).reset()
    ...
    def chain(self):
        ...
        """
        return super(EnsembleSamplerTEC, self).chain
    ...
    def lnprobability(self):
        ...
        """
        return super(EnsembleSamplerTEC, self).lnprobability
    ...
    def flatlnprobability(self):
        ...
        """
        return super(EnsembleSamplerTEC, self).lnprobability.flatten()
    ...
    def acceptance_fraction(self):
        ...
        """
        return super(EnsembleSamplerTEC, self).acceptance_fraction
