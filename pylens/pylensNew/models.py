...
class _PointMass(_MassModel):
    ...
    def deflections(self,x,y):
        ...
        dy = y-self.y
        r2=(dx**2+dy**2)
        r2[r2==0]+=1e-7 #avoid divide by zero errors


        # I think this is the point mass deflections :/
        alpha_x = (self.b**2)*(dx*1./r2)#negative sign is in dx already
        alpha_y = (self.b**2)*(dy*1./r2)
